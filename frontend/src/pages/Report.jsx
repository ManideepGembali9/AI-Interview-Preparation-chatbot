...
const styles = {
  ...
  title: { fontSize: '32px', fontWeight: '800', color: 'var(--text-primary)' },
  titleMobile: { fontSize: '26px' },
  homeBtn: { background: 'linear-gradient(135deg, var(--primary), var(--primary-strong))', border: 'none', color: 'white', padding: '10px 20px', borderRadius: '8px', cursor: 'pointer', fontWeight: '600', boxShadow: '4px 4px 0 rgba(91,93,246,0.22)' },
  backBtn: { background: '#fff', borderTop: '2px solid rgba(255,255,255,0.98)', borderLeft: '2px solid rgba(255,255,255,0.9)', borderBottom: '2px solid rgba(91,93,246,0.24)', borderRight: '2px solid rgba(124,58,237,0.18)', color: 'var(--text-primary)', padding: '10px 20px', borderRadius: '8px', cursor: 'pointer', fontWeight: '600', boxShadow: '3px 3px 0 rgba(91,93,246,0.10)' },
  ...
  scoreNum: { fontSize: '40px', fontWeight: '800', lineHeight: 1, color: 'var(--text-primary)' },
  scoreMax: { color: 'var(--text-secondary)', fontSize: '14px' },
  perfLevel: { fontSize: '20px', fontWeight: '700', color: 'var(--primary)' },
  detailsCard: { padding: '32px' },
  detailsCardMobile: { padding: '20px' },
  sectionTitle: { fontSize: '18px', fontWeight: '800', marginBottom: '24px', color: 'var(--text-primary)' },
  ...
  dVal: { fontSize: '16px', fontWeight: '600', color: 'var(--text-primary)' },
  metricsCard: { padding: '32px', marginBottom: '24px' },
  barGrid: { display: 'grid', gap: '20px' },
  barLabelGroup: { display: 'flex', justifyContent: 'space-between', marginBottom: '8px', fontSize: '14px', fontWeight: '700', color: 'var(--text-primary)' },
  barBg: { height: '10px', background: '#dbe7ff', borderRadius: '5px', overflow: 'hidden', borderTop: '1px solid rgba(255,255,255,0.95)', borderLeft: '1px solid rgba(255,255,255,0.85)', borderBottom: '1px solid rgba(91,93,246,0.18)', borderRight: '1px solid rgba(124,58,237,0.12)' },
  barFill: { height: '100%', background: 'linear-gradient(90deg, var(--primary), var(--accent))', borderRadius: '5px', boxShadow: '1px 0 4px rgba(91,93,246,0.32)' },
  ...
  errorText: { color: '#64748b', marginBottom: '20px' },
