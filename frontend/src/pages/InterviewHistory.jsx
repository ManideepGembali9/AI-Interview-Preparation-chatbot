...
const styles = {
  ...
  homeBtn: { background: '#fff', color: 'var(--text-primary)', padding: '10px 20px', borderRadius: '10px', borderTop: '2px solid rgba(255,255,255,0.98)', borderLeft: '2px solid rgba(255,255,255,0.9)', borderBottom: '2px solid rgba(91,93,246,0.24)', borderRight: '2px solid rgba(124,58,237,0.18)', fontWeight: '600', cursor: 'pointer', boxShadow: '3px 3px 0 rgba(91,93,246,0.10)' },
  ...
  title: { fontSize: '36px', fontWeight: '800', marginBottom: '8px', color: 'var(--text-primary)' },
  titleMobile: { fontSize: '28px' },
  subtitle: { color: 'var(--text-secondary)' },
  backBtn: { background: 'linear-gradient(135deg, var(--primary), var(--primary-strong))', color: 'white', padding: '12px 24px', borderRadius: '12px', border: 'none', fontWeight: '600', cursor: 'pointer', boxShadow: '4px 4px 0 rgba(91,93,246,0.22), 0 10px 22px rgba(91,93,246,0.24)' },
  ...
  statVal: { fontSize: '48px', fontWeight: '800', color: 'var(--primary)', marginBottom: '8px' },
  ...
  role: { fontSize: '20px', fontWeight: '700', marginBottom: '8px', color: 'var(--text-primary)' },
  ...
  chatBtn: { flex: 1, background: 'rgba(6,182,212,0.12)', color: '#0369a1', borderTop: '2px solid rgba(255,255,255,0.98)', borderLeft: '2px solid rgba(255,255,255,0.9)', borderBottom: '2px solid rgba(6,182,212,0.24)', borderRight: '2px solid rgba(14,165,233,0.18)', padding: '10px', borderRadius: '8px', fontWeight: '600', cursor: 'pointer', boxShadow: '3px 3px 0 rgba(6,182,212,0.12)' },
  reportBtn: { flex: 1, background: 'linear-gradient(135deg, #111827, #1f2937)', color: '#ffffff', border: 'none', padding: '10px', borderRadius: '8px', fontWeight: '600', cursor: 'pointer', boxShadow: '4px 4px 0 rgba(15,23,42,0.18)' },
  resumeBtn: { flex: 1, background: 'linear-gradient(135deg, var(--primary), var(--primary-strong))', color: 'white', border: 'none', padding: '10px', borderRadius: '8px', fontWeight: '600', cursor: 'pointer', boxShadow: '3px 3px 0 rgba(91,93,246,0.2)' },
  delBtn: { background: 'rgba(239,68,68,0.10)', color: 'var(--danger)', borderTop: '2px solid rgba(255,255,255,0.98)', borderLeft: '2px solid rgba(255,255,255,0.9)', borderBottom: '2px solid rgba(239,68,68,0.30)', borderRight: '2px solid rgba(239,68,68,0.22)', padding: '10px 16px', borderRadius: '8px', fontWeight: '600', cursor: 'pointer', boxShadow: '3px 3px 0 rgba(239,68,68,0.12)' },
  ...
  modalHeader: { display: 'flex', alignItems: 'center', justifyContent: 'space-between', gap: '16px', borderBottom: '1px solid rgba(91,93,246,0.18)', paddingBottom: '12px', marginBottom: '12px' },
  modalHeaderMobile: { flexDirection: 'column', alignItems: 'flex-start' },
  modalTitle: { margin: 0, fontSize: '24px', fontWeight: 700, color: 'var(--text-primary)' },
  modalTitleMobile: { fontSize: '20px' },
  modalSub: { margin: '4px 0 0', color: 'var(--text-secondary)' },
  closeBtn: { background: '#fff', color: 'var(--text-primary)', borderTop: '2px solid rgba(255,255,255,0.98)', borderLeft: '2px solid rgba(255,255,255,0.9)', borderBottom: '2px solid rgba(91,93,246,0.24)', borderRight: '2px solid rgba(124,58,237,0.18)', padding: '8px 14px', borderRadius: '8px', fontWeight: 600, cursor: 'pointer', boxShadow: '3px 3px 0 rgba(91,93,246,0.10)' },
  ...
  userBubble: { maxWidth: '78%', background: 'linear-gradient(135deg, var(--primary), var(--primary-strong))', color: 'white', borderRadius: '14px 14px 4px 14px', padding: '10px 12px', boxShadow: '4px 4px 0 rgba(91,93,246,0.18)' },
  aiBubble: { maxWidth: '78%', background: '#fff', borderTop: '2px solid rgba(255,255,255,0.98)', borderLeft: '2px solid rgba(255,255,255,0.9)', borderBottom: '2px solid rgba(91,93,246,0.24)', borderRight: '2px solid rgba(124,58,237,0.18)', color: 'var(--text-primary)', borderRadius: '14px 14px 14px 4px', padding: '10px 12px', boxShadow: '3px 3px 0 rgba(91,93,246,0.10)' },
